    ...
    >
      ...
      <div className="user-card__details">
        <div className="user-card__detail">
          ...
          <a href={`mailto:${user.email}`} onClick={(e) => e.stopPropagation()} aria-label={`Email ${user.name}`}>
            {user.email}
          </a>
        </div>
        <div className="user-card__detail">
        ...
        <div className="user-card__detail">
          ...
          <a href={`https://${user.website}`} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} aria-label={`Visit ${user.name}'s website`}>
            {user.website}
          </a>
        </div>
      </div>
      ...
      <div className="user-card__tags">
        <span className="user-card__tag">{user.address.city}</span>
        <span className="user-card__tag">{user.company.name}</span>
      </div>
    </article>
  )
})
